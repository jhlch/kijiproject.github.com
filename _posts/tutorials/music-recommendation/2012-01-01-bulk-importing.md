...
---
Here at Pandforify, we have about a millenia of data collected about our user's listening patterns.
This would take A huge amount of time to load into a Kiji table we used a single machine to issue
write to our table, one row at a time. Instead we will show you how to use MapReduce to efficiently
import such large amounts of data into Kiji.
